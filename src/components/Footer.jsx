  ...
  return (
    <footer id="contact" style={{ background: '#1B1B1B', color: '#F5F9F5', padding: '2rem 0', textAlign: 'center' }}>
      <div className="container">
        ...
        <p style={{ opacity: 0.9, marginBottom: '1.2rem', fontSize: '0.95rem', color: '#C0C0C0' }}>Pure Nature. Proven Strength.</p>
        ...
        <div style={{ margin: '1rem 0', opacity: 0.85, fontSize: '0.9rem', lineHeight: '1.5' }}>
          ...
          <p style={{ margin: '0', color: '#C0C0C0' }}>Hairoca Hair Oil, Udalakkav, Adat(PO)</p>
          <p style={{ margin: '0', color: '#C0C0C0' }}>Thrissur Dt, Kerala 680551</p>
          <p style={{ margin: '0', color: '#C0C0C0' }}>Phone: +91 80891 64334</p>
        </div>
